...
class WpCourses_Post_types {
	...
	public function __construct() {
		...
		add_action('init', array(__CLASS__, 'WPC_register_post_types'), 5);
		add_action('init', array(__CLASS__, 'WPC_register_taxonomies'), 5);
	}

	/**
	 * Rester post types
	 */
	public static function WPC_register_post_types () {
	...
	public static function WPC_register_taxonomies () {
